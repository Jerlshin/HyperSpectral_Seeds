    ...
    def forward(
        ...
        if self.training:
            ...
            if labels is not None:
                aux_list = [aux_out["aux_a"], aux_out["aux_b"], aux_out["aux_c"], aux_out["aux_d"]]
                # This mathematically forces branch decorrelation during backprop
                ba, bb, bc, bd = apply_goal(ba, bb, bc, bd, aux_list, labels)
